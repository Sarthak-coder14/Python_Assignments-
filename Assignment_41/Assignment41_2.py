...
# explaination of why pediction change when  k increa
# -> ~ When K is considered as 1, it means only one nearest point will be considered for prediction.
#      That is why the prediction can sometimes be wrong.
#
#    ~ But when we take the square root of N as the value of K, it is considered a good choice.
#      In this case, the prediction becomes more accurate.